  ...
  const options: DialogueOption[] = [
    {
      ...
      action: () => {
        ...
        currentStore.startAndFinishQuest('marius', 'Beruhige Marius vor dem Auftritt');
    ...
    },
    {
      ...
      action: () => {
        ...
        if (currentStore.flags.askedAbout1982) {
          currentStore.setDialogue('Marius: "1982... ja. Als die Gießerei bebte. Wenn wir das überlebt haben, ist Tangermünde ein Kinderspiel."');
          currentStore.setFlag('mariusCalmed', true);
          currentStore.startAndFinishQuest('marius', 'Beruhige Marius vor dem Auftritt');
          currentStore.setFlag('mariusConfidenceBoost', true);
          currentStore.increaseBandMood(25);
        ...
        currentStore.setDialogue('Marius: "1982? Da war ich noch nicht mal in der Band. Wovon redest du? Das macht mich nur noch nervöser!"');
