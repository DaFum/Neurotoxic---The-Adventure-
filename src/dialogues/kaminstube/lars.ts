        ...
        ...(!store.flags.lars_drum_maintenance && store.hasItem('Lötkolben') ? [
          {
            ...
            action: () => {
              ...
              currentStore.increaseBandMood(15, 'dialogues_kaminstube_lars_19');
  ...
  const options: DialogueOption[] = [
    {
      ...
      action: () => {
        ...
        currentStore.increaseBandMood(15, 'dialogues_kaminstube_lars_42');
    ...
    },
    {
      ...
      action: () => {
        ...
        currentStore.setFlag('kaminstube_lars_talked', true);
        currentStore.increaseBandMood(20, 'dialogues_kaminstube_lars_55');
  ...
  if (store.flags.larsRhythmPact) {
    options.unshift({
      ...
      action: () => {
        ...
        currentStore.setFlag('kaminstube_lars_talked', true);
        currentStore.increaseBandMood(10, 'dialogues_kaminstube_lars_80');
      },
    });
  }
