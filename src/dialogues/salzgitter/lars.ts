...
export function buildSalzgitterLarsDialogue(): Dialogue {
      ...
      options: [
          ...
          : []),
        {
          ...
          action: () => {
            ...
            currentStore.setDialogue('Lars: "KEINE ZEIT FÜR PAUSEN! NUR NOCH LÄRM!"');
          },
        },
      ],
    };
  ...
  if (bandMood > 70) {
    return say('Lars: "MEIN HERZ SCHLÄGT IM TAKT DER MASCHINEN! ICH BIN BEREIT!"');
  }

  return say('Lars: "Die Drums sind mikrofoniert. Ich bin bereit, alles zu geben!"');
}
