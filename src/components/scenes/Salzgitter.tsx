      ...
      <Interactable
        ...
        onInteract={() => {
          ...
          options.push(
             ...
             { text: 'Lasst uns zusammen singen! [Social 8]', requiredSkill: { name: 'social', level: 8 }, action: () => {
             ...
             { text: 'Wir sind alle eins mit der Musik. [Diplomat]', requiredTrait: 'Diplomat', action: () => {
