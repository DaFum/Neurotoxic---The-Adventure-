  ...
  return (
    <>
      ...
      <Interactable
        ...
        name="Wirt"
        onInteract={() => {
          useStore.getState().setDialogue(buildKaminstubeWirtDialogue());
        }}
      />
      ...
      {!flags.ampFixed && (
        <Interactable
          ...
          scale={1.2}
          onInteract={() => {
            useStore.getState().setDialogue(buildKaminstubeAmpDialogue());
          }}
        />
      )}
      ...
      <Interactable
        ...
        onInteract={() => {
          ...
          if (!store.flags.kaminstubeDrumLoreHeard) {
            store.increaseBandMood(10, 'components_scenes_Kaminstubex_589');
      ...
      <Interactable
        ...
        scale={2}
        onInteract={() => {
          useStore.getState().setDialogue(buildKaminstubeCrowdDialogue());
        }}
      />
      ...
      {flags.ampFixed && (
        <Interactable
          ...
          scale={1.5}
          onInteract={() => {
            setDialogue(buildKaminstubeExitDialogue());
            if (exitTimeoutRef.current !== null) {
              window.clearTimeout(exitTimeoutRef.current);
            }
