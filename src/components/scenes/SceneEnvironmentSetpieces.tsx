...
export function SceneEnvironmentSetpieces({ variant }: SceneEnvironmentSetpiecesProps) {
  if (variant === 'proberaum') {
    return (
      <group>
        ...
        {[-11.8, -7.2, -2.6, 2.6, 7.2, 11.8].map((x, idx) => (
        ...
        {[[-13.6, 2.8, -5.7], [13.6, 2.8, -5.7], [-13.6, 2.8, 3.2], [13.6, 2.8, 3.2]].map((pos, idx) => (
          <group key={`proberaum-junction-${idx}`} position={pos as [number, number, number]}>
            <mesh castShadow receiveShadow>
  ...
  if (variant === 'tourbus') {
    return (
      <group>
        ...
        {[-4.8, -3.2, -1.6, 0, 1.6, 3.2, 4.8].map((x, idx) => (
  ...
  if (variant === 'void_station') {
    return (
      <group>
        {[7.5, 12.5, 17.5].map((r, idx) => (
        ...
        {[[-15, 0.9, -12], [-7, 1.2, -16], [7, 1.3, -16], [15, 0.9, -12], [-15, 1.1, 12], [15, 1.1, 12]].map((pos, idx) => (
          <group key={`void-pylon-${idx}`} position={pos as [number, number, number]}>
            <mesh castShadow receiveShadow>
  ...
  if (variant === 'kaminstube') {
    return (
      <group>
        ...
        {[[-13.2, 0.72, -3.6], [13.2, 0.72, -3.6], [-13.2, 0.72, 1.8], [13.2, 0.72, 1.8]].map((pos, idx) => (
          <group key={`kaminstube-barrels-${idx}`} position={pos as [number, number, number]}>
            <mesh castShadow receiveShadow>
  ...
  return (
    <group>
      {[[-15, 3.2, -7.8], [15, 3.2, -7.8], [-15, 3.2, -3.8], [15, 3.2, -3.8]].map((pos, idx) => (
        <group key={`salzgitter-tower-${idx}`} position={pos as [number, number, number]}>
          <mesh castShadow receiveShadow>
