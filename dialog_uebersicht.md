...
- **Ersatzröhre (Item):**
  - _Interaktion:_ Aufheben (Erhalt: Röhre). Bei erreichtem Pickup-Limit erscheint ein expliziter Hinweistext statt stiller Erfolgsannahme. _Hinweis: Der Pickup wird versteckt, sobald die `amp` Quest abgeschlossen ist (oder `ampFixed` gesetzt ist)._
- **Kaputter Amp:**
