...
* **Verstecktes Fach (Nur nach Sabotage-Entdeckung):**
    * *Interaktion (Skill: Technical 3):* Öffnen — gibt Frequenzfragment **nur wenn Quest `frequenz_1982` bereits aktiv** (bei erfolgreicher Aufnahme: +10 BandMood, setzt `frequenz1982_tourbus`). Ohne aktive Quest: nur Notiz lesbar (kein Mood-Effekt). Bei erreichtem Pickup-Limit erscheint ein Hinweistext ohne Flag-Set und ohne +10 BandMood.
* **Batterie (Item):**
    * *Interaktion:* Aufheben (Erhalt: Batterie).
* **Geist eines Roadies:**
