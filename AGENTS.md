...
- Keep [dialog_uebersicht.md](dialog_uebersicht.md) in sync when editing dialogue, quests, item interactions, or BandMood logic in [src/components/scenes/](src/components/scenes/), [src/dialogues/](src/dialogues/), or [src/store/](src/store/).
